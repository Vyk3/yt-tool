...
- **Per-Item Playlist Format Selection**: Probe, select, or manually enter formats per playlist item; retry individual failures without blocking the full playlist
...
- **Local Data Management**: Back up and clear local history, subscriptions, and preferences from Settings
...
- **HLS / DASH Download Optimization**: HLS and DASH streams use the native downloader with parallel fragment downloads, avoiding aria2c connection overhead on small segments
