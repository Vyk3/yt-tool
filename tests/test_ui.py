...
class TestTerminalSize:
    def test_ignores_zero_columns_env_and_uses_explicit_override(self, monkeypatch):
        ...
        monkeypatch.setattr("app.cli.ui._ioctl_terminal_size_for_path", lambda path: None)
        monkeypatch.setattr("app.cli.ui._stty_terminal_size", lambda path: None)
        monkeypatch.setattr("app.cli.ui._tput_terminal_columns", lambda path: None)
        monkeypatch.setattr("app.cli.ui._darwin_parent_tty_paths", lambda: [])
        monkeypatch.setattr("app.cli.ui._darwin_parent_fd_tty_paths", lambda: [])
